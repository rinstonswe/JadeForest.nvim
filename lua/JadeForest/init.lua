local bufferline = require 'JadeForest.integrations.bufferline'
local cmp = require 'JadeForest.integrations.cmp'
local colorscheme = require 'JadeForest.colorscheme'
local config = require 'JadeForest.config'
local utils = require 'JadeForest.utils'
local theme = {}
...
function theme.colorscheme()
  if vim.version().minor < 8 then
    vim.notify(
      'Neovim 0.8+ is required for JadeForest colorscheme',
